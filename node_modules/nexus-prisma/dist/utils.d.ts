 ...
 */
export declare type LocalComputedInputs<MethodName extends MutationMethodName> = Record<string, (params: LocalMutationResolverParams<MethodName>) => unknown>;
...
export declare type LocalMutationResolverParams<MethodName extends MutationMethodName> = BaseMutationResolverParams & {
    args: core.GetGen<'argTypes'>['Mutation'][MethodName];
};
export declare type MutationMethodName = keyof core.GetGen<'argTypes'>['Mutation'];
