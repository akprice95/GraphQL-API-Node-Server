...
interface NexusPrismaInputs {
  Query: {
    stats: {
  filtering: 'id' | 'createdAt' | 'updatedAt' | 'name' | 'KD' | 'GamerTag' | 'Platform' | 'AND' | 'OR' | 'NOT'
  ordering: 'id' | 'createdAt' | 'updatedAt' | 'name' | 'KD' | 'GamerTag' | 'Platform'
}
...
interface NexusPrismaTypes {
  ...
  Mutation: {
    createOneStats: 'Stats'
    updateOneStats: 'Stats'
    updateManyStats: 'BatchPayload'
    deleteOneStats: 'Stats'
    deleteManyStats: 'BatchPayload'
    upsertOneStats: 'Stats'
